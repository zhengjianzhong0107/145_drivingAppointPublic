<template>
  <el-breadcrumb class="app-breadcrumb" separator="/" style="height:40px;backgroundColor:var(--publicMainColor);borderRadius:4px;padding:0px 20px 0px 20px;boxShadow: 0px 6px 6px var(--publicSubColor);borderWidth:0;borderStyle:dotted solid double dashed;borderColor:#ff0000;">
